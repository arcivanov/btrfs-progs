...
/*
 * Written by Arcadiy Ivanov (arcadiy@ivanov.biz)
 */
...
const struct btrfs_convert_operations xfs_convert_ops = {
	.name			= "xfs",
	.open_fs		= xfs_open_fs,
	.read_used_space	= xfs_read_used_space,
	.copy_inodes		= xfs_copy_inodes,
	.close_fs		= xfs_close_fs,
	.check_state		= xfs_check_state,
};

#endif	/* BTRFSCONVERT_XFS */
